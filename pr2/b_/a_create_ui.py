...
class Window(QtWidgets.QWidget):
    ...
    def initUi(self) -> None:
        ...
        self.labelLogin = QtWidgets.QLabel()  # TODO Создайте виджет QLabel с текстом "Логин"
        self.labelLogin.setText("Логин")

        self.labelRegistration = QtWidgets.QLabel()  # TODO Создайте виджет QLabel с текстом "Регистрация"
        self.labelRegistration.setText("Регистрация")
