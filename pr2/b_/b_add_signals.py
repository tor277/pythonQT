...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonPlainTextEdit.clicked.connect(self.onPushBattonPlainTextEdit)  # TODO подключить слот для вывода текста из plaineTextEdit в plainTextEditLog при нажатии на кнопку
        ...
        self.pushButtonClearLog.clicked.connect(self.onPushButtonCleaningLog)  # TODO подключить слот для очистки plainTextEditLog при нажатии на кнопку
    ...
    # slots --------------------------------------------------------------
    def onPushButtonComboBox(self):
        combo_box = self.comboBox.currentText()
        self.plainTextEditLog.setPlainText(combo_box)
    ...
    def onPushBattonPlainTextEdit(self):
        self.plainTextEditLog.setPlainText(self.plainTextEdit.toPlainText())

    def onPushButtonSpinBox(self):
        spin_box = self.spinBox.value()
        self.plainTextEditLog.setPlainText(f'{spin_box}')

    def onPushButtonDoubleSpinBox(self):
        double_spin_box = self.doubleSpinBox.value()
        self.plainTextEditLog.setPlainText(f'{double_spin_box}')

    def onPushButtonTimeEdit (self):
        time_edit = self.timeEdit.text()
        self.plainTextEditLog.setPlainText(time_edit)

    def onPushButtonDateTimeEdit (self):
        date_time_edit = self.dateTimeEdit.text()
        self.plainTextEditLog.setPlainText(date_time_edit)
